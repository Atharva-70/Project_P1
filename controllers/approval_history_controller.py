...
def get_history(claim_id):
    """
    Returns chronological audit trail for a given expense claim.
    Direct arbitrary status mutation via POST /approval_history is restricted to validated domain workflow services.
    """
